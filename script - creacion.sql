...
CREATE TABLE [POLACA_INVERSA].FACTURAS (
	...
	CUIT VARCHAR(50) FOREIGN KEY REFERENCES POLACA_INVERSA.EMPRESAS(CUIT),
...
CREATE TABLE [POLACA_INVERSA].DEVOLUCIONES(
	...
	ID_FACTURA INT FOREIGN KEY REFERENCES [POLACA_INVERSA].FACTURAS(ID_FACTURA),
...
CREATE TABLE [POLACA_INVERSA].ITEMS_FACTURAS(
	...
	CANTIDAD INT,
	MONTO FLOAT,
	PRIMARY KEY(ID_DETALLE,ID_ITEM),
)
GO
CREATE TABLE [POLACA_INVERSA].FACTURAS_RENDIDAS(
	...
	ID_FACTURAS INT FOREIGN KEY REFERENCES [POLACA_INVERSA].FACTURAS(ID_FACTURA),
	CANT_FAC_REND INT,
	TOTAL_RENDICION INT,
