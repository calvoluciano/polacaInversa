...
BEGIN
	...
	SELECT DISTINCT [Pago_nro],[Pago_Fecha],[Total],[FormaPagoDescripcion],(select ID_SUCURSAL from POLACA_INVERSA.SUCURSALES WHERE CODIGO_POSTAL = Sucursal_Codigo_Postal), (select ID_CLIENTE FROM POLACA_INVERSA.CLIENTES where DNI = [Cliente-Dni])  
